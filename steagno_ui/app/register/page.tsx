...
const RegisterPage = () => {
  ...
  const getStrength = () => {
    ...
    if (pass.length === 0) return { width: "0%", color: "bg-slate-200" }
    if (pass.length < 6) return { width: "33%", color: "bg-rose-500" }
    if (pass.length < 10) return { width: "66%", color: "bg-amber-500" }
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-6 relative overflow-hidden selection:bg-indigo-100">
      ...
      {/* --- REGISTER CARD --- */}
      <div className="w-full max-w-[480px] bg-white/70 backdrop-blur-2xl rounded-[40px] border border-white shadow-[0_32px_64px_rgba(0,0,0,0.06)] p-8 md:p-12 relative z-10">
        {/* Logo & Header */}
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-slate-500 font-medium mt-2">
            Join the secure steganography network
          </p>
        </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-50 focus:border-indigo-500 outline-none transition-all font-medium text-slate-900 placeholder:text-slate-300"
                required
                onChange={(e) =>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              ...
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-11 pr-12 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl focus:ring-4 focus:ring-indigo-50 focus:border-indigo-500 outline-none transition-all font-medium text-slate-900 placeholder:text-slate-300"
                required
                onChange={(e) =>
            ...
            <div className="h-1 w-full bg-slate-100 rounded-full mt-2 overflow-hidden">
              <div
                className={`h-full transition-all duration-500 ${getStrength().color}`}
